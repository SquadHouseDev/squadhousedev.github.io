...
Hi there! Welcome to the website (the “**Site**”) of Alpha Exploration Co., Inc. (dba “SquadHouse”), (“**Company**,” “**we**,” “**us**,” or “**our**”). Through our mobile application (the “**App**”), we allow users to engage in audio conversations with friends and other people around the world (such services, including [insert site](insert site) (the “**Site**”) and the App, are referred to collectively in this Privacy Policy as the “**Service**”).
